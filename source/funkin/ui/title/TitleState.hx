...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(!initialized || forceShowIntro)
		{
			...
			{
				funkin.util.WindowMode.setBorderlessFullscreen(FlxG.save.data.fullscreen);
		...
		#elseif TEST
		MusicBeatState.switchState(new funkin.ui.debug.isolated.MD3IsolatedComponentState());
		#else
		...
		if(!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 4:
					deleteCoolText();
				case 5:
					createCoolText(['nao associado', 'a'], -40);
				case 6:
