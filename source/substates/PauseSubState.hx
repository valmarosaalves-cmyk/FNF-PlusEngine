...
class PauseSubState extends MusicBeatSubstate
{
    ...
    override function create()
    {
        ...
        dateTimeText = new FlxText(0, 15 + 96, FlxG.width, LocaleUtils.formatDateTime(now), 32);
        ...
        var blueballedTxt:FlxText = new FlxText(0, 15 + 64, FlxG.width, 
            Language.getPhrase("blueballed", "Blueballed: {1}", [PlayState.deathCounter]), 32);
    ...
    override function update(elapsed:Float)
    {
        ...
        if (dateTimeText != null) {
            var now:Date = Date.now();
            dateTimeText.text = LocaleUtils.formatDateTime(now);
        }
        ...
        if (controls.ACCEPT && (cantUnpause <= 0 || !controls.controllerMode))
        {
            ...
            switch (daSelected)
            {
                ...
                case 'Options':
                    ...
                    if(ClientPrefs.data.pauseMusic != 'None' && ClientPrefs.data.pauseMusic != null)
                    {
    ...
    {
        if (songName == null && (ClientPrefs.data.pauseMusic == null || ClientPrefs.data.pauseMusic == 'None'))
            return null;
            
        var formattedSongName:String = (songName != null ? Paths.formatToSongPath(songName) : '');
        var formattedPauseMusic:String = (ClientPrefs.data.pauseMusic != null ? Paths.formatToSongPath(ClientPrefs.data.pauseMusic) : 'none');
