...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if(WeekData.weeksList.length < 1)
		{
			...
			MusicBeatState.switchState(new funkin.ui.ErrorState("NO WEEKS ADDED FOR STORY MODE\n\nPress " + accept + " to go to the Week Editor Menu.\nPress " + reject + " to return to Main Menu.",
				function() MusicBeatState.switchState(new funkin.ui.debug.WeekEditorState()),
	...
	function selectWeek()
	{
		...
		new FlxTimer().start(1, function(tmr:FlxTimer)
		{
			...
			funkin.ui.freeplay.FreeplayState.destroyFreeplayVocals();
