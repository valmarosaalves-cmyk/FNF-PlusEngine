...
class IdID 
{
    ...
    public static var translations:Map<String, String> = [
        ...
        "setting_fullscreen_mode-borderless_fix" => "Perbaikan Tanpa Batas",
        "setting_fullscreen_mode-exclusive" => "Eksklusif",
        "description_fullscreen_mode" => "Mengubah cara tampilan layar penuh berperilaku.\\n\\nTanpa Batas: Jendela tanpa batas standar\\nPerbaikan Tanpa Batas: Menggunakan API native untuk akurasi yang lebih baik\\nEksklusif: Layar penuh tradisional (dapat diminimalkan saat menggunakan Alt-Tab)",
        ...
        "setting_health_bar_opacity" => "Opasitas Bar Kesehatan",
        ...
        "description_discord_rich_presence" => "Batalkan centang ini untuk mencegah bocoran yang tidak disengaja, hal ini akan menyembunyikan Aplikasi dari kotak \"Playing\" Anda di Discord.",
        ...
        "setting_judgement_counter" => "Penghitung Penilaian",
        "description_judgement_counter" => "Tampilkan penghitung penilaian selama game.",
        ...
        "setting_pause_countdown" => "Jeda Countdown",
        "description_pause_countdown" => "Jika dicentang, saat melanjutkan dari mode pause, countdown akan diputar\nsama seperti countdown pada intro.",
        "setting_hey_intro" => "Halo Pengantar",
        "description_hey_intro" => "Jika dicentang, saat countdown mengatakan Ayo!, baik BF maupun GF\nakan secara otomatis melakukan animasi Hey!.",
        "setting_break_timer" => "Pengatur Timer",
        "description_break_timer" => "Jika dicentang, timer akan muncul saat note berikutnya mendekat\n(Terinspirasi dari FNF Vs Matt Void Chronicles).",
        ...
        "description_holds_behind_strums" => "Jika dicentang: Menampilkan sustain di belakang garis strum.\nJika tidak dicentang: Menampilkan sustain di atas garis strum.",
        ...
        "setting_manage_mods" => "Kelola Mods",
        "description_manage_mods" => "Akses cepat ke folder mods. Tambahkan, hapus, atau edit file mod.",
        "setting_browse_saves" => "Telusuri Saves",
        "description_browse_saves" => "Lihat dan kelola berkas saves anda.",

        // Mobile Control Select Menu
        "mobileC_exitandsave" => "Keluar & Simpan",
        "pad-extra_save" => "Pad-Extra Hanyalah Opsi Pengikatan.\nSilakan Pilih Sebuah Opsi Berbeda Untuk Keluar.",
