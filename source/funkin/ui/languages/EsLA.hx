...
class EsLA 
{
    ...
    public static var translations:Map<String, String> = [
        ...
        "score_text_legacy" => "Puntuación: {1} | Fallas: {2} | Clasificación: {3}",
        ...
        "setting_color_accessibility-none" => "Ninguno",
        "setting_color_accessibility-protanomaly" => "Protanomalia",
        "setting_color_accessibility-deuteranomaly" => "Deuteranomalia",
        "setting_color_accessibility-tritanomaly" => "Tritanomalia",
        "setting_color_accessibility-Achromatomaly" => "Achromatomalia",
        "setting_gpu_caching" => "Almac. caché en GPU",
        ...
        "setting_color_quantization" => "Cuantización de color",
        "description_color_quantization" => "Si se marca, las notas se colorearan dependiendo la subdivisión, igual como stepmania. Recolorea a las notas por defecto.",
        ...
        "description_key_viewer_color-gray" => "Gris",
        "description_key_viewer_color-red" => "Rojo",
        "description_key_viewer_color-green" => "Verde",
        "description_key_viewer_color-blue" => "Azul",
        "description_key_viewer_color-orange" => "Naranja",
        "description_key_viewer_color-purple" => "Morado",
        "description_key_viewer_color-cyan" => "Cian",
        "description_key_viewer_color-pink" => "Rosa",
        "description_key_viewer_color-white" => "Blanco",
        "description_key_viewer_color-black" => "Negro",
        "setting_icon_bounce" => "Rebote de íconos:",
        "description_icon_bounce" => "Selecciona tu tipo de bump preferido. Nota: Algunos scripts que usen los iconos pueden romperse si no esta en por defecto.",
        "description_icon_bounce-default" => "Defecto",
        ...
        "setting_fullscreen_mode" => "Modo de p. completa:",
        "description_fullscreen_mode" => "Selecciona tu modo de pantalla completa preferido.\nBordes: perfecto para usar Alt-Tab, Excluxivo: perfecto para mas rendimiento del juego.\n(Debe reiniciar el juego para que tenga efecto)",
        ...
        "setting_show_combo_sprite" => "Mostrar sprite de combo",
        "description_show_combo_sprite" => "Si está marcado, muestra el sprite de combo además de los números.",
        ...
        "setting_version_text_on_gameplay" => "Texto de versión en juego",
        "description_version_text_on_gameplay" => "Si está marcado, muestra el texto de versión del motoren la parte superior central del juego.",
        ...
        "setting_aligned_receptors" => "Notas alineadas",
        "description_aligned_receptors" => "Las notas se alinean como en el V-Slice original, NOTA: Puede causar roturas de scripts si manejan las notas.",
        ...
        "setting_hitsound_in_what_way-none" => "Ninguno",
        "setting_hitsound_in_what_way-keys" => "Teclas",
        "setting_hitsound_in_what_way-notes" => "Notas",  
        "setting_hitsound_sound" => "Sonido del hitsound:",
        "description_hitsound_sound" => "¿Qué sonido quieres para el hitsound?",
        "setting_hitsound_sound-default" => "Predeterminado",
        ...
        "setting_legacy_filesystem_access" => "Acceso al sistema de archivos heredado",
        "description_legacy_filesystem_access" => "Si está marcado, se usará el sistema de acceso al sistema de archivos de Psych 0.7.3.\nActiva si tienes problemas con mods anteriores.",
        "setting_use_legacy_font" => "Usar fuente heredada",
        ...
        "setting_z_axis_depth_scale" => "Escala de profundidad del eje Z",
        "description_z_axis_depth_scale" => "Ajusta la escala de profundidad del eje Z para mejorar la percepción de profundidad en el juego.\nValores más altos aumentan la profundidad, mientras que valores más bajos la reducen.",
        ...
        "setting_extra_controls-none" => "Ninguno",
        "setting_extra_controls-single" => "Uno",
        "setting_extra_controls-double" => "Dos",
        ...
        "setting_device_perfomance_info" => "Información de rendimiento del dispositivo",
        "setting_show_debug_buttons" => "Mostrar botones de depuración",
        "description_show_debug_buttons" => "Si está marcado, muestra botones de depuración T y D",
