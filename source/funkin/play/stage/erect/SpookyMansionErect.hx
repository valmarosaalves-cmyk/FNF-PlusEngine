...
class SpookyMansionErect extends BaseStage
{
	...
	override function goodNoteHit(note:funkin.play.notes.Note)
	{
	...
	override function noteMiss(note:funkin.play.notes.Note)
	{
		var anims:Array<String> = ['singLEFT', 'singDOWN', 'singUP', 'singRIGHT'];
		if(boyfriendGhost != null)
	...
	override function opponentNoteHit(note:funkin.play.notes.Note)
	{
		var anims:Array<String> = ['singLEFT', 'singDOWN', 'singUP', 'singRIGHT'];
		if(dadGhost != null)
